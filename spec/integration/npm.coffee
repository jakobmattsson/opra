...
""", {
  '.opra-cache/index.html-npm/JSON.js': containsText('var require = function', 'require.define("/json2.js"')
  '.opra-cache/index.html-npm/underscore.js': containsText('require.define("/underscore.js"', "_.VERSION = '1.1.0'")
